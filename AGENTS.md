...
fixtures/              language-neutral test data both halves are checked against — see fixtures/README.md
...
Fixtures for all of this live in `fixtures/`, generated by `client/tools/`. They
are checked in and regenerating them should produce no diff unless something
genuinely changed — see `fixtures/README.md`.
